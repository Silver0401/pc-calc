...
const LeftBox = (props) => {
    ...
    useEffect(() => {
        ...
        anime({
            ...
            delay: anime.stagger(100, {grid: [9,9], from:"first"})
        })
    ...
    return(
        <section className="LeftBox" style={props.state ? {visibility:"visible"}: {display:"none"}}>
        
            <div id="GridAnim">
                <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/>
                <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/>
                <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/>
                <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/>
                <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/> <span id="Box"/>
